        ...
        <div class="branding docs-branding">
            <div class="container-fluid position-relative py-2">
                <div class="docs-logo-wrapper">
                    ...
                    <div class="site-logo"><a class="navbar-brand" onclick="openNav()" href="javascript:void(0)"><img class="logo-icon mr-2" src="@{{Assets}}/assets/images/coderdocs-logo.svg" alt="logo"><span class="logo-text" id="appname-text-1">Showcase<span class="text-alt" id="appname-text-2">Docs</span></span></a></div>    
